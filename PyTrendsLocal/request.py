...
class TrendReq(object):
    ...
    def top_charts(self, date, hl='en-US', tz=300, geo='GLOBAL'):
        ...
        data_arr = []
        try:
            for data in req_json['topCharts']:
                try:
                    keywords_arr = []
                    for keyword in data['listItems']:
                        keywords_arr.append(keyword['title'])
                    data_arr.append({'category' : data['listTitle'] , 'keywords' : keywords_arr})
